    ...
    <section class="lm-section" aria-labelledby="homeWorkflowTitle">
        <div class="container">
            <div class="lm-media-block">
                ...
                <figure>
                    <img src="{{ asset('images/marketing/tour/tour-3.jpg') }}" alt="Screenshot of the LevelMinds pipeline dashboard">
            ...
            <div class="lm-product-slider carousel slide" id="homeSpotlight" data-bs-ride="carousel" aria-label="Platform screenshots">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('images/marketing/tour/tour-1.jpg') }}" class="d-block w-100" alt="Applicant pipeline dashboard overview">
                        <div class="lm-product-caption">Applicant pipeline: monitor every stage in one unified dashboard.</div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('images/marketing/tour/tour-2.jpg') }}" class="d-block w-100" alt="Teacher dashboard tracking applications">
                        <div class="lm-product-caption">Teacher dashboard: keep educators updated with real-time status changes.</div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('images/marketing/tour/tour-3.jpg') }}" class="d-block w-100" alt="Interview scheduling interface">
                        <div class="lm-product-caption">Scheduling: align interview panels and reminders without leaving LevelMinds.</div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('images/marketing/tour/tour-4.jpg') }}" class="d-block w-100" alt="Candidate profile with teaching evidence">
                        <div class="lm-product-caption">Candidate profile: review teaching evidence, lesson plans, and credentials.</div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('images/marketing/tour/tour-5.jpg') }}" class="d-block w-100" alt="Scorecard review and feedback screen">
                        <div class="lm-product-caption">Scorecards: capture rubric-aligned feedback from every panelist.</div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('images/marketing/tour/tour-6.jpg') }}" class="d-block w-100" alt="Hiring analytics snapshot">
                        <div class="lm-product-caption">Analytics: understand pipeline health and the sources bringing great teachers.</div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('images/marketing/tour/tour-7.jpg') }}" class="d-block w-100" alt="Team tasks and follow-up checklist">
