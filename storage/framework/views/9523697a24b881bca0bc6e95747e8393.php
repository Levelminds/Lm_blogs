...
<body style="font-family:Arial, sans-serif; background:#f9f9f9; padding:30px;">
    <div style="max-width:600px;margin:auto;background:#fff;padding:20px;border-radius:8px;">
        <h2 style="color:#0047FF;">Welcome to LevelMinds Blog!</h2>
        <p>Hi there,</p>
        <p>Thank you for subscribing to our blog updates.</p>
        <p>Click the button below to confirm your subscription:</p>

        <p style="text-align:center;">
            <a href="<?php echo e(route('subscribe.confirm', $subscription->confirmation_token)); ?>"
...
<?php /**PATH C:\xampp\htdocs\levelminds-laravel\resources\views/emails/subscription-confirmation.blade.php ENDPATH**/ ?>