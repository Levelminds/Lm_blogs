                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="meta_title" name="meta_title"
                                                   value="<?php echo e(old('meta_title')); ?>" class="form-control"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="meta_description" name="meta_description" rows="2"
                                                      class="form-control"
                                                      placeholder="One or two sentences summarising this blog (max ~160 characters)"><?php echo e(old('meta_description')); ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea id="meta_keywords" name="meta_keywords" rows="2"
                                                      class="form-control"
                                                      placeholder="Comma separated keywords e.g. teachers, school hiring"><?php echo e(old('meta_keywords')); ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="url" id="canonical_url" name="canonical_url"
                                                   value="<?php echo e(old('canonical_url')); ?>" class="form-control"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="og_title" name="og_title"
                                                   value="<?php echo e(old('og_title')); ?>" class="form-control"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="og_description" name="og_description" rows="2"
                                                      class="form-control"
                                                      placeholder="Social sharing description (defaults to meta description)"><?php echo e(old('og_description')); ?></textarea>
                                        </div>
                                        <div class="mb-0">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u420143207/domains/levelminds.in/public_html/resources/views/admin/blogs/create.blade.php ENDPATH**/ ?>