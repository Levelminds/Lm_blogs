...
?>
<?php $__env->startSection('meta_description', 'Explore '.$category->name.' articles and insights curated by LevelMinds.'); ?>
<?php $__env->startSection('meta_keywords', strtolower($category->name).', education, levelminds'); ?>
<?php $__env->startSection('og_title', $category->name.' Blogs | LevelMinds'); ?>
<?php $__env->startSection('og_image', optional($categoryLead)->og_image_url ?? optional($categoryLead)->thumbnail_url ?? asset('images/branding/logo.svg')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u420143207/domains/levelminds.in/public_html/resources/views/blogs/category.blade.php ENDPATH**/ ?>