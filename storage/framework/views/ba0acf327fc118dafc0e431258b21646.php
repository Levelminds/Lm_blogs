                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="excerpt" name="excerpt" rows="3" class="form-control"
                                          placeholder="Short summary shown on listings (max 400 characters)"><?php echo e(old('excerpt', $blog->excerpt)); ?></textarea>
                            </div>

                            <div class="mb-3">
                                <label for="content" class="form-label fw-semibold">Body</label>
                                <input id="content" type="hidden" name="content"
                                       value="<?php echo e(old('content', $blog->content)); ?>">
                        ...
                        <div class="col-md-4">
                                ...
                                <select id="category_id" name="category_id" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>"
                                            <?php if(old('category_id', $blog->category_id) == $category->id): echo 'selected'; endif; ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="media_type" name="media_type" class="form-select" required>
                                    <option value="article" <?php if(old('media_type', $blog->media_type) === 'article'): echo 'selected'; endif; ?>>Article</option>
                                    <option value="video" <?php if(old('media_type', $blog->media_type) === 'video'): echo 'selected'; endif; ?>>Video</option>
                                </select>
                            </div>

                            <div class="mb-3 video-settings <?php echo e(old('media_type', $blog->media_type) === 'video' ? '' : 'd-none'); ?>">
                            ...
                            <div class="mb-3 video-settings <?php echo e(old('media_type', $blog->media_type) === 'video' ? '' : 'd-none'); ?>">
                                ...
                                <input type="url" id="external_video_url" name="external_video_url"
                                       value="<?php echo e(old('external_video_url', $blog->external_video_url)); ?>"
                                ...
                                <div class="mb-3 video-settings <?php echo e(old('media_type', $blog->media_type) === 'video' ? '' : 'd-none'); ?>">
                                    ...
                                    <?php if($blog->video_path): ?>
                                        <video class="w-100 rounded shadow-sm" controls>
                                            <source src="<?php echo e($blog->video_stream_url); ?>" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    <?php elseif($blog->external_video_url): ?>
                                        <a href="<?php echo e($blog->external_video_url); ?>" class="btn btn-outline-primary btn-sm" target="_blank" rel="noopener">
                                            View external video
                                        </a>
                                    <?php endif; ?>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="meta_title" name="meta_title"
                                                   value="<?php echo e(old('meta_title', $blog->meta_title)); ?>" class="form-control"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="meta_description" name="meta_description" rows="2"
                                                      class="form-control"
                                                      placeholder="One or two sentences summarising this blog (max ~160 characters)"><?php echo e(old('meta_description', $blog->meta_description)); ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea id="meta_keywords" name="meta_keywords" rows="2"
                                                      class="form-control"
                                                      placeholder="Comma separated keywords"><?php echo e(old('meta_keywords', $blog->meta_keywords)); ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="url" id="canonical_url" name="canonical_url"
                                                   value="<?php echo e(old('canonical_url', $blog->canonical_url)); ?>" class="form-control"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="og_title" name="og_title"
                                                   value="<?php echo e(old('og_title', $blog->og_title)); ?>" class="form-control"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="og_description" name="og_description" rows="2"
                                                      class="form-control"
                                                      placeholder="Social sharing description (defaults to meta description)"><?php echo e(old('og_description', $blog->og_description)); ?></textarea>
                                        </div>
                                        <div class="mb-0">
                                            ...
                                            <?php if($blog->og_image_url): ?>
                                                <div class="mt-3">
                                                    <span class="d-block fw-semibold mb-2">Current sharing image</span>
                                                    <img src="<?php echo e($blog->og_image_url); ?>" alt="<?php echo e($blog->title); ?>" class="img-fluid rounded shadow-sm">
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" id="published_at" name="published_at"
                                       class="form-control"
                                       value="<?php echo e(old('published_at', optional($blog->published_at)->format('Y-m-d\TH:i'))); ?>">
                            </div>

                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" role="switch"
                                       id="is_featured" name="is_featured" value="1"
                                       <?php if(old('is_featured', $blog->is_featured)): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u420143207/domains/levelminds.in/public_html/resources/views/admin/blogs/edit.blade.php ENDPATH**/ ?>