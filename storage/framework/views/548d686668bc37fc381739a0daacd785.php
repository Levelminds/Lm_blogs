                            ...
                            <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                                <div class="row g-0 align-items-stretch">
                                    <div class="col-lg-5 hero-media">
                                        ...
                                        <?php elseif($post->is_video && $post->video_embed_url): ?>
                                            <div class="ratio ratio-16x9">
                                                <iframe src="<?php echo e($post->video_embed_url); ?>" title="<?php echo e($post->title); ?> video"
                                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                                        allowfullscreen loading="lazy"></iframe>
                                            </div>
                                        <?php elseif($post->is_video && $post->video_stream_url): ?>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card blog-card h-100">
                                <div class="card-img-wrap">
                                    ...
                                    <?php elseif($highlight->is_video && $highlight->video_embed_url): ?>
                                        <div class="ratio ratio-16x9">
                                            <iframe src="<?php echo e($highlight->video_embed_url); ?>" title="<?php echo e($highlight->title); ?> video"
                                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                                    allowfullscreen loading="lazy"></iframe>
                                        </div>
                                    <?php elseif($highlight->is_video && $highlight->video_stream_url): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u420143207/domains/levelminds.in/public_html/resources/views/blogs/index.blade.php ENDPATH**/ ?>